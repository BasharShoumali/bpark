...
CREATE TABLE `parkings` (
  `parking_space` int NOT NULL AUTO_INCREMENT,
  `status` enum('available','taken') DEFAULT 'available',
  PRIMARY KEY (`parking_space`)
...
INSERT INTO `parkings` VALUES (1,'taken'),(2,'taken'),(3,'taken'),(4,'taken'),(5,'taken'),(6,'taken'),(7,'taken'),(8,'taken'),(9,'taken'),(10,'taken'),(11,'taken'),(12,'taken'),(13,'taken'),(14,'taken');
